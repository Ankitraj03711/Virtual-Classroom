...
const BACKEND_URL = React.useMemo(() => import.meta.env.VITE_BACKEND_URL, []);
    ...
    const openSubmissionFile = (rawUrl) => {
        ...
        if (!openedWindow) {
            toast("Unable to open file. Please allow pop-ups in your browser.");
        }
    };
